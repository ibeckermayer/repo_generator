...
The file `iacta` will be in the working directory
  ...
  * You're not allowed to use `sed`
    ...
    adopted in Italian (Il dado e tratto), Romanian (Zarurile au fost aruncate),
    Spanish (La suerte esta echada), French (Les des sont jetes), Portuguese (A
    sorte esta lançada), Dutch (De teerling is geworpen),
    German (Der Wurfel ist gefallen), Hungarian (A kocka el van vetve) and many other languages to
...
the text) spells out a word, message or the alphabet. The word comes from the
French acrostiche from post-classical Latin acrostichis). As a form of
constrained writing, an acrostic can be used as a mnemonic device to aid
memory retrieval. [Read more](/rltoken/V8wUlT1trv0XGLfOIFgu6w "Read more").
